<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" validateRequest="false" AutoEventWireup="true" CodeFile="AddActivity.aspx.cs" Inherits="Admin_AddActivity" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="breadcrumb"><h3>ADD NEWS</h3> </div>
        
       <div class="col-sm-6 col-md-6">

     Enter News Title: <asp:TextBox ID="txttitle" runat="server" class="form-control" ></asp:TextBox>
      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
               ErrorMessage=" Plz Enter the Title" ControlToValidate="txttitle" 
               Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>

    <br />
     Enter News Details:<asp:TextBox ID="txtDetails" runat="server" 
     ...
     <asp:Label ID="lbl2" runat="server" Text=""></asp:Label>
       ...
       &nbsp; &nbsp; &nbsp; <asp:Button ID="Button3" runat="server" Text="Submit" 
           ...
           <asp:SqlDataSource ID="sdsActivity" runat="server" 
               ...
               SelectCommand="SELECT [ActivityId], [Title], [Details], [Image1], [Image2], [Type], [Date] FROM [Activity]">
           </asp:SqlDataSource>
