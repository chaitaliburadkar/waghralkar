<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Addaward.aspx.cs" Inherits="Admin_Addaward" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="breadcrumb"><h3>ADD AWARD</h3></div>
        
       <div class="col-sm-6 col-md-6">
    Enter Award  Title: <asp:TextBox ID="txttitle" runat="server" class="form-control" ></asp:TextBox>
      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage=" Plz Enter the Title" ControlToValidate="txttitle" ForeColor="#FF3300"></asp:RequiredFieldValidator>

    <br />
     Enter Award Details:<asp:TextBox ID="txtDetails" runat="server" 
               class="form-control" TextMode="MultiLine" ></asp:TextBox>
<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
               ErrorMessage="Plz Enter the Details" ControlToValidate="txtDetails" ForeColor="#FF3300"></asp:RequiredFieldValidator>
     ...
     <div class="col-sm-6 col-md-6">
       ...
       &nbsp; &nbsp; &nbsp; <asp:Button ID="Button3" runat="server" Text="Submit" 
           ...
           <asp:SqlDataSource ID="sdsActivity" runat="server" 
               ...
               SelectCommand="SELECT [ActivityId], [Title], [Details], [Image1], [Image2], [Type], [Date] FROM [Award]">
           </asp:SqlDataSource>
